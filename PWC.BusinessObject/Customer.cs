...
namespace PWC.BusinessObject
{
    ...
    #region Mapped Members
        ...
        private void WriteForecast(StreamWriter sw, Forecast forecast, SqlInt32 currentMonthActualSales)
        {
            ...
            var forecastNamePreffix = "BAS";
            var customerNumber = _distinctForecastNameFlag ? CustomerNumber.Value : "ZZZZ";

            if (!forecast.PY01.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY01", forecast.CreatedDate.Value), forecast.PY01);
            if (!forecast.PY02.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY02", forecast.CreatedDate.Value), forecast.PY02);
            if (!forecast.PY03.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY03", forecast.CreatedDate.Value), forecast.PY03);
            if (!forecast.PY04.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY04", forecast.CreatedDate.Value), forecast.PY04);
            if (!forecast.PY05.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY05", forecast.CreatedDate.Value), forecast.PY05);
            if (!forecast.PY06.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY06", forecast.CreatedDate.Value), forecast.PY06);
            if (!forecast.PY07.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY07", forecast.CreatedDate.Value), forecast.PY07);
            if (!forecast.PY08.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY08", forecast.CreatedDate.Value), forecast.PY08);
            if (!forecast.PY09.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY09", forecast.CreatedDate.Value), forecast.PY09);
            if (!forecast.PY10.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY10", forecast.CreatedDate.Value), forecast.PY10);
            if (!forecast.PY11.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY11", forecast.CreatedDate.Value), forecast.PY11);
            if (!forecast.PY12.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("PY12", forecast.CreatedDate.Value), forecast.PY12);
            if (!forecast.CY01.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY01", forecast.CreatedDate.Value), forecast.CY01 - (DateTime.Today.Month == 1 ? currentMonthActualSales : 0));
            if (!forecast.CY02.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY02", forecast.CreatedDate.Value), forecast.CY02 - (DateTime.Today.Month == 2 ? currentMonthActualSales : 0));
            if (!forecast.CY03.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY03", forecast.CreatedDate.Value), forecast.CY03 - (DateTime.Today.Month == 3 ? currentMonthActualSales : 0));
            if (!forecast.CY04.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY04", forecast.CreatedDate.Value), forecast.CY04 - (DateTime.Today.Month == 4 ? currentMonthActualSales : 0));
            if (!forecast.CY05.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY05", forecast.CreatedDate.Value), forecast.CY05 - (DateTime.Today.Month == 5 ? currentMonthActualSales : 0));
            if (!forecast.CY06.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY06", forecast.CreatedDate.Value), forecast.CY06 - (DateTime.Today.Month == 6 ? currentMonthActualSales : 0));
            if (!forecast.CY07.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY07", forecast.CreatedDate.Value), forecast.CY07 - (DateTime.Today.Month == 7 ? currentMonthActualSales : 0));
            if (!forecast.CY08.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY08", forecast.CreatedDate.Value), forecast.CY08 - (DateTime.Today.Month == 8 ? currentMonthActualSales : 0));
            if (!forecast.CY09.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY09", forecast.CreatedDate.Value), forecast.CY09 - (DateTime.Today.Month == 9 ? currentMonthActualSales : 0));
            if (!forecast.CY10.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY10", forecast.CreatedDate.Value), forecast.CY10 - (DateTime.Today.Month == 10 ? currentMonthActualSales : 0));
            if (!forecast.CY11.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY11", forecast.CreatedDate.Value), forecast.CY11 - (DateTime.Today.Month == 11 ? currentMonthActualSales : 0));
            if (!forecast.CY12.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("CY12", forecast.CreatedDate.Value), forecast.CY12 - (DateTime.Today.Month == 12 ? currentMonthActualSales : 0));
            if (!forecast.NY01.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY01", forecast.CreatedDate.Value), forecast.NY01);
            if (!forecast.NY02.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY02", forecast.CreatedDate.Value), forecast.NY02);
            if (!forecast.NY03.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY03", forecast.CreatedDate.Value), forecast.NY03);
            if (!forecast.NY04.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY04", forecast.CreatedDate.Value), forecast.NY04);
            if (!forecast.NY05.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY05", forecast.CreatedDate.Value), forecast.NY05);
            if (!forecast.NY06.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY06", forecast.CreatedDate.Value), forecast.NY06);
            if (!forecast.NY07.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY07", forecast.CreatedDate.Value), forecast.NY07);
            if (!forecast.NY08.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY08", forecast.CreatedDate.Value), forecast.NY08);
            if (!forecast.NY09.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY09", forecast.CreatedDate.Value), forecast.NY09);
            if (!forecast.NY10.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY10", forecast.CreatedDate.Value), forecast.NY10);
            if (!forecast.NY11.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY11", forecast.CreatedDate.Value), forecast.NY11);
            if (!forecast.NY12.IsNull) sw.WriteLine("{0},{1}{2}{3},{4},{5},{6}", companyCode, forecastNamePreffix, customerNumber, forecast.ForecastMethod, forecast.ItemNumber, calendar.GetMMdash01dashYY("NY12", forecast.CreatedDate.Value), forecast.NY12);
        }
...
#if TEMPGROUPING
        internal List<ForecastExport> ExportForecast(bool subtractCurrentMonthSales)
        {
            ...
            foreach (var forecast in ForecastCollection)
            {
                ...
                {
                    var actualSales =
                        ActualSalesCollection[
                            new ActualSalesKey(forecast.CompanyCode, forecast.CustomerNumber, forecast.ItemNumber,
                                               new SqlDateTime(DateTime.Today.Year, DateTime.Today.Month, 1))];
                    if (actualSales != null && actualSales.Quantity > SqlInt32.Zero)
                        actualSalesQuantity = actualSales.Quantity;
                }
                forecastExports.AddRange(WriteForecast(forecast, actualSalesQuantity));
            }
            _forecastCollection = null; //release the memory for GC
            return forecastExports;
        }
        ...
        private List<ForecastExport> WriteForecast(Forecast forecast, SqlInt32 currentMonthActualSales)
        {
            ...
            if (!forecast.PY01.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY01", forecast.CreatedDate.Value), Quantity = forecast.PY01 });
            if (!forecast.PY02.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY02", forecast.CreatedDate.Value), Quantity = forecast.PY02 });
            if (!forecast.PY03.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY03", forecast.CreatedDate.Value), Quantity = forecast.PY03 });
            if (!forecast.PY04.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY04", forecast.CreatedDate.Value), Quantity = forecast.PY04 });
            if (!forecast.PY05.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY05", forecast.CreatedDate.Value), Quantity = forecast.PY05 });
            if (!forecast.PY06.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY06", forecast.CreatedDate.Value), Quantity = forecast.PY06 });
            if (!forecast.PY07.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY07", forecast.CreatedDate.Value), Quantity = forecast.PY07 });
            if (!forecast.PY08.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY08", forecast.CreatedDate.Value), Quantity = forecast.PY08 });
            if (!forecast.PY09.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY09", forecast.CreatedDate.Value), Quantity = forecast.PY09 });
            if (!forecast.PY10.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY10", forecast.CreatedDate.Value), Quantity = forecast.PY10 });
            if (!forecast.PY11.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY11", forecast.CreatedDate.Value), Quantity = forecast.PY11 });
            if (!forecast.PY12.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("PY12", forecast.CreatedDate.Value), Quantity = forecast.PY12 });

            if (!forecast.CY01.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY01", forecast.CreatedDate.Value), Quantity = forecast.CY01 - (DateTime.Today.Month == 1 ? currentMonthActualSales : 0) });
            if (!forecast.CY02.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY02", forecast.CreatedDate.Value), Quantity = forecast.CY02 - (DateTime.Today.Month == 2 ? currentMonthActualSales : 0) });
            if (!forecast.CY03.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY03", forecast.CreatedDate.Value), Quantity = forecast.CY03 - (DateTime.Today.Month == 3 ? currentMonthActualSales : 0) });
            if (!forecast.CY04.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY04", forecast.CreatedDate.Value), Quantity = forecast.CY04 - (DateTime.Today.Month == 4 ? currentMonthActualSales : 0) });
            if (!forecast.CY05.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY05", forecast.CreatedDate.Value), Quantity = forecast.CY05 - (DateTime.Today.Month == 5 ? currentMonthActualSales : 0) });
            if (!forecast.CY06.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY06", forecast.CreatedDate.Value), Quantity = forecast.CY06 - (DateTime.Today.Month == 6 ? currentMonthActualSales : 0) });
            if (!forecast.CY07.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY07", forecast.CreatedDate.Value), Quantity = forecast.CY07 - (DateTime.Today.Month == 7 ? currentMonthActualSales : 0) });
            if (!forecast.CY08.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY08", forecast.CreatedDate.Value), Quantity = forecast.CY08 - (DateTime.Today.Month == 8 ? currentMonthActualSales : 0) });
            if (!forecast.CY09.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY09", forecast.CreatedDate.Value), Quantity = forecast.CY09 - (DateTime.Today.Month == 9 ? currentMonthActualSales : 0) });
            if (!forecast.CY10.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY10", forecast.CreatedDate.Value), Quantity = forecast.CY10 - (DateTime.Today.Month == 10 ? currentMonthActualSales : 0) });
            if (!forecast.CY11.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY11", forecast.CreatedDate.Value), Quantity = forecast.CY11 - (DateTime.Today.Month == 11 ? currentMonthActualSales : 0) });
            if (!forecast.CY12.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("CY12", forecast.CreatedDate.Value), Quantity = forecast.CY12 - (DateTime.Today.Month == 12 ? currentMonthActualSales : 0) });

            if (!forecast.NY01.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY01", forecast.CreatedDate.Value), Quantity = forecast.NY01 });
            if (!forecast.NY02.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY02", forecast.CreatedDate.Value), Quantity = forecast.NY02 });
            if (!forecast.NY03.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY03", forecast.CreatedDate.Value), Quantity = forecast.NY03 });
            if (!forecast.NY04.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY04", forecast.CreatedDate.Value), Quantity = forecast.NY04 });
            if (!forecast.NY05.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY05", forecast.CreatedDate.Value), Quantity = forecast.NY05 });
            if (!forecast.NY06.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY06", forecast.CreatedDate.Value), Quantity = forecast.NY06 });
            if (!forecast.NY07.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY07", forecast.CreatedDate.Value), Quantity = forecast.NY07 });
            if (!forecast.NY08.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY08", forecast.CreatedDate.Value), Quantity = forecast.NY08 });
            if (!forecast.NY09.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY09", forecast.CreatedDate.Value), Quantity = forecast.NY09 });
            if (!forecast.NY10.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY10", forecast.CreatedDate.Value), Quantity = forecast.NY10 });
            if (!forecast.NY11.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY11", forecast.CreatedDate.Value), Quantity = forecast.NY11 });
            if (!forecast.NY12.IsNull) forecastExports.Add(new ForecastExport { CompanyCode = companyCode, ForecastNamePrefix = forecastNamePreffix, CustomerNumber = customerNumber, ForecastMethod = forecast.ForecastMethod, ItemNumber = forecast.ItemNumber, Month = calendar.GetMMdash01dashYY("NY12", forecast.CreatedDate.Value), Quantity = forecast.NY12 });
        ...
        public void PopulateForecastFromCsv(string fileName)
        {
